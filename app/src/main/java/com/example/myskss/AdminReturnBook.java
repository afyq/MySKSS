...
public class AdminReturnBook extends AppCompatActivity {
    ...
    private boolean getUser() {
        db.collection("Users").whereEqualTo("card_number", Integer.parseInt(editCardNo2.getEditText().getText().toString().trim())).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
